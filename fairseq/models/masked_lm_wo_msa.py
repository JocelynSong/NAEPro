...
@register_model("masked_lm_wo_msa")
class MaskedLMModelNoMSA(FairseqEncoderModel):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument("--trained-on-unsupervised-data",
                            action="store_true",
                            help="if trained on unsupervised data")
        parser.add_argument(
    ...
    def build_model(cls, args, task):
        ...
        encoder = MaskedLMEncoderNoMSA(args, task.dictionary)
        return cls(args, encoder)


class MaskedLMEncoderNoMSA(FairseqEncoder):
    """
    ...
    def __init__(self, args, dictionary):
        ...
        self.trained_on_unsupervised_data = args.trained_on_unsupervised_data
...
@register_model_architecture("masked_lm_wo_msa", "masked_lm_wo_msa")
def base_architecture(args):
    ...
    args.trained_on_unsupervised_data = getattr(
        args, "trained_on_unsupervised_data", True)
...
@register_model_architecture("masked_lm_wo_msa", "masked_lm_wo_msa_base")
...
@register_model_architecture("masked_lm_wo_msa", "masked_lm_wo_msa_large")
...
@register_model_architecture("masked_lm_wo_msa", "masked_lm_wo_msa_xlm_base")
